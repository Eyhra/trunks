...
/*************************************/
#if PACKETVER_MAIN_NUM >= 20201104 || PACKETVER_RE_NUM >= 20211103 || PACKETVER_ZERO_NUM >= 20201118
struct PACKET_ZC_REPUTATION_sub {
	uint8 id;
	int32 useless1;
	int16 useless2;
	int8 useless3;
...
struct PACKET_ZC_REPUTATION {
	int16 PacketType;
	int16 PacketLength;
	int8 refresh;
	struct PACKET_ZC_REPUTATION_sub list[];
} __attribute__((packed));
DEFINE_PACKET_HEADER(PACKET_ZC_REPUTATION, 0x0b8d)

//18
struct PACKET_ZC_REPUTATION_OPEN {
	int16 PacketType;
	uint8 groupID; // see on client contentdata\repute\reputegroupdata.bson
	int32 useless1;
	int16 useless2;
	int8 useless3;
	uint8 reputID;
...
DEFINE_PACKET_HEADER(PACKET_ZC_REPUTATION_OPEN, 0x0b8e)
#endif  // PACKETVER_MAIN_NUM >= 20201104 || PACKETVER_ZERO_NUM >= 20201118
