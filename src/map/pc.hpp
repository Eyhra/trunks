...
struct map_session_data {
	...
	struct s_state {
		...
		bool refineui_open;
		unsigned int buttonsound : 1; // @buttonsound
	...
	int cart_bkp_weight, cart_bkp_num, cart_bkp_weight_max;
	int fd;
...
//=========================================================================================	
	 ...
	 * ------------------------------------------------
	 * Seta o vector que será utilizado para armazenar
	 * as skills temporárias que foram adiquiridas
	 *-------------------------------------------------*/
	std::vector<skillTemp> Skills_Temp;
...
void pc_check_temp_skill(struct map_session_data* sd, uint16 skill_id); /// [NeoWolfer]
