 ...
 * -------------------------------------------------------
 * Cria a struct que guardará todas as skills temporárias
 *--------------------------------------------------------*/
typedef struct {
	uint16 skill_id;
} skillTemp;
...
//4-1 Jobs
	...
	MAPID_ARCH_MAGE = JOBL_FOURTH|MAPID_WARLOCK_T,
	MAPID_WINDHAWK = JOBL_FOURTH|MAPID_RANGER_T,
	MAPID_CARDINAL = JOBL_FOURTH|MAPID_ARCH_BISHOP_T,
	MAPID_MEISTER = JOBL_FOURTH|MAPID_MECHANIC_T,
	MAPID_SHADOW_CROSS = JOBL_FOURTH|MAPID_GUILLOTINE_CROSS_T,
	MAPID_SKY_EMPEROR = JOBL_FOURTH|MAPID_STAR_EMPEROR,
//4-2 Jobs
	MAPID_IMPERIAL_GUARD = JOBL_FOURTH|MAPID_ROYAL_GUARD_T,
	MAPID_ELEMENTAL_MASTER = JOBL_FOURTH|MAPID_SORCERER_T,
	MAPID_TROUBADOURTROUVERE = JOBL_FOURTH|MAPID_MINSTRELWANDERER_T,
	MAPID_INQUISITOR = JOBL_FOURTH|MAPID_SURA_T,
	MAPID_BIOLO = JOBL_FOURTH|MAPID_GENETIC_T,
	MAPID_ABYSS_CHASER = JOBL_FOURTH|MAPID_SHADOW_CHASER_T,
//More extendend
	MAPID_SOUL_ASCETIC = JOBL_FOURTH|MAPID_SOUL_REAPER,
	MAPID_NIGHT_WATCH = JOBL_FOURTH|MAPID_REBELLION,
	MAPID_SHINKIRO_SHIRANUI = JOBL_FOURTH|MAPID_KAGEROUOBORO,
...
// used by map_setcell()
	...
	MF_NOEQUIP_OFF,
	MF_NOAURA,
	MF_SKILL_ITEMCOST,	// Skill Item Cost
	MF_MAX
};
...
// Skill Item Cost
struct s_skill_itemcost {
	uint16 skill_id; ///< Skill ID
	t_itemid item_id[3]; ///< Item ID
};
...
union u_mapflag_args {
	...
	struct s_skill_itemcost skill_itemcost;	// Skill Item Cost
...
struct map_data {
	...
	std::unordered_map<uint16, s_skill_itemcost> skill_itemcost;	// Skill Item Cost
...
void map_skill_itemcost_add(struct map_data *mapd, s_skill_itemcost skill_itemcost);	// Skill Item Cost
...
extern char cart_items_table[32];
extern char cart_bkp_items_table[32];
