...
#define SCRIPT_CONSTANTS_HPP
	...
	export_constant(MF_ANTIMOB);
	export_constant(MF_EQUIP_HIDE);
	export_constant(MF_NOEQUIP_OFF);
	export_constant(MF_SKILL_ITEMCOST);
...
/// @APIHOOK_START(EFST_CONST)
	...
	export_constant(EFST_AUTO_FIRING_LAUNCHER);
...
/// Do not modify code above this, since it will be automatically generated by the API again
	...
	export_constant(UMOB_DAMAGETAKEN); // By: KyoSasuke#5401
	export_constant(UMOB_DAMAGETAKEN_DB); // By: KyoSasuke#5401
