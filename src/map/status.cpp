...
void initChangeTables(void)
{
	...
	set_sc( AL_ANGELUS		, SC_ANGELUS		, EFST_ANGELUS		, SCB_MAXHP
#ifdef RENEWAL
		|SCB_MAXHP );
#else
		);
...
#endif
	set_sc( PR_SUFFRAGIUM		, SC_SUFFRAGIUM		, EFST_SUFFRAGIUM		, SCB_MATK|SCB_NONE );
...
//#endif
	...
	set_sc_with_vfx_noskill( SC_ID_CAST	, EFST_ID_CAST	, SCB_NONE );
	set_sc_with_vfx_noskill( SC_ID_ASPD	, EFST_ID_ASPD	, SCB_ASPD );
	set_sc_with_vfx_noskill( SC_ID_MAXHP	, EFST_ID_MAXHP	, SCB_MAXHP );
	set_sc_with_vfx_noskill( SC_ID_MAXSP	, EFST_ID_MAXSP	, SCB_MAXSP );
	set_sc_with_vfx_noskill( SC_ID_ALLSTATS	, EFST_ID_ALLSTATS	, SCB_STR|SCB_AGI|SCB_VIT|SCB_DEX|SCB_INT|SCB_LUK );
	set_sc_with_vfx_noskill( SC_ID_SPEED	, EFST_ID_SPEED	, SCB_SPEED );
	set_sc_with_vfx_noskill( SC_ID_ATK	, EFST_ID_ATK	, SCB_BATK );
	set_sc_with_vfx_noskill( SC_ID_MATK	, EFST_ID_MATK	, SCB_MATK );
...
//#ifdef RENEWAL
	...
	set_sc( MT_RUSH_QUAKE               , SC_RUSH_QUAKE2       , EFST_RUSH_QUAKE2       , SCB_NONE );
	set_sc_with_vfx(          MT_RUSH_QUAKE               , SC_RUSH_QUAKE1        , EFST_RUSH_QUAKE1        , SCB_NONE );
	...
	// Imperial Guard
	set_sc(          IG_GUARD_STANCE      , SC_GUARD_STANCE , EFST_GUARD_STANCE , SCB_WATK|SCB_MAXHP );
	...
	set_sc(          IG_ATTACK_STANCE     , SC_ATTACK_STANCE, EFST_ATTACK_STANCE, SCB_PATK|SCB_SMATK|SCB_DEF );
	...
	set_sc(          BO_HELL_DUSTY          , SC_BO_HELL_DUSTY     , EFST_BO_HELL_DUSTY             , SCB_NONE );
	...
	// Soul Ascetic
	set_sc(SOA_TALISMAN_OF_PROTECTION, SC_TALISMAN_OF_PROTECTION, EFST_TALISMAN_OF_PROTECTION, SCB_NONE);
	set_sc(SOA_TALISMAN_OF_WARRIOR, SC_TALISMAN_OF_WARRIOR, EFST_TALISMAN_OF_WARRIOR, SCB_WATK);
	set_sc(SOA_TALISMAN_OF_MAGICIAN, SC_TALISMAN_OF_MAGICIAN, EFST_TALISMAN_OF_MAGICIAN, SCB_MATK);
	set_sc(SOA_TALISMAN_OF_FIVE_ELEMENTS, SC_TALISMAN_OF_FIVE_ELEMENTS, EFST_TALISMAN_OF_FIVE_ELEMENTS, SCB_ALL);
	set_sc(SOA_TALISMAN_OF_BLUE_DRAGON, SC_T_FIRST_GOD, EFST_T_FIRST_GOD, SCB_NONE);
	...
	set_sc(SOA_SOUL_OF_HEAVEN_AND_EARTH, SC_HEAVEN_AND_EARTH, EFST_HEAVEN_AND_EARTH, SCB_NONE);

	//Spirit Handler
	set_sc_with_vfx(SH_HOWLING_OF_CHUL_HO, SC_HOGOGONG, EFST_HOGOGONG, SCB_NONE);
	set_sc(SH_MARINE_FESTIVAL_OF_KI_SUL, SC_MARINE_FESTIVAL_OF_KI_SUL, EFST_MARINE_FESTIVAL, SCB_POW|SCB_CON|SCB_CRT);
	set_sc(SH_SANDY_FESTIVAL_OF_KI_SUL, SC_SANDY_FESTIVAL, EFST_SANDY_FESTIVAL, SCB_SPL | SCB_WIS | SCB_STA);
	set_sc(SH_KI_SUL_RAMPAGE, SC_KI_SUL_RAMPAGE, EFST_KI_SUL_RAMPAGE, SCB_NONE);
	set_sc(SH_COLORS_OF_HYUN_ROK, SC_COLORS_OF_HYUN_ROK, EFST_COLORS_OF_HYUN_ROK_BUFF, SCB_NONE);
	set_sc(SH_TEMPORARY_COMMUNION, SC_TEMPORARY_COMMUNION, EFST_TEMPORARY_COMMUNION, SCB_PATK | SCB_SMATK | SCB_HPLUS);
	set_sc(SH_BLESSING_OF_MYSTICAL_CREATURES, SC_BLESSING_OF_M_CREATURES, EFST_BLESSING_OF_M_CREATURES, SCB_PATK | SCB_SMATK);

	//Hyper Novice
	set_sc_with_vfx(HN_SHIELD_CHAIN_RUSH, SC_SHIELDCHAINRUSH, EFST_SHIELDCHAINRUSH, SCB_SPEED);
	set_sc_with_vfx(HN_JACK_FROST_NOVA, SC_MISTYFROST, EFST_MISTYFROST, SCB_NONE);
	set_sc_with_vfx(HN_GROUND_GRAVITATION, SC_GROUNDGRAVITY, EFST_GROUNDGRAVITY, SCB_SPEED);
	set_sc(HN_BREAKINGLIMIT, SC_BREAKINGLIMIT, EFST_BREAKINGLIMIT, SCB_NONE);
	set_sc(HN_RULEBREAK, SC_RULEBREAK, EFST_RULEBREAK, SCB_NONE);

	//Sky Emperor
	set_sc_with_vfx(SKE_STAR_BURST, SC_STAR_BURST, EFST_STAR_BURST, SCB_NONE);
	set_sc(SKE_ENCHANTING_SKY, SC_SKY_ENCHANT, EFST_SKY_ENCHANT, SCB_NONE);

	//Shinkiro Shiranui
	set_sc(SS_TOKEDASU, SC_SHADOW_CLOCK, EFST_SHADOW_CLOCK, SCB_SPEED);
	set_sc(SS_SHIMIRU, SC_SHADOW_CLOCK, EFST_SHADOW_CLOCK, SCB_SPEED);
	set_sc(SS_KUNAIKAITEN, SC_SHADOW_CLOCK, EFST_SHADOW_CLOCK, SCB_SPEED);
	set_sc(SS_SHINKIROU, SC_SHINKIROU_CALL, EFST_SBUNSHIN, SCB_SPEED);
	set_sc_with_vfx(SS_KAGEGARI, SC_NIGHTMARE, EFST_NIGHTMARE, SCB_NONE);

	StatusIconChangeTable[SC_COLORS_OF_HYUN_ROK_1] = EFST_COLORS_OF_HYUN_ROK_1;
	StatusIconChangeTable[SC_COLORS_OF_HYUN_ROK_2] = EFST_COLORS_OF_HYUN_ROK_2;
	StatusIconChangeTable[SC_COLORS_OF_HYUN_ROK_3] = EFST_COLORS_OF_HYUN_ROK_3;
	StatusIconChangeTable[SC_COLORS_OF_HYUN_ROK_4] = EFST_COLORS_OF_HYUN_ROK_4;
	StatusIconChangeTable[SC_COLORS_OF_HYUN_ROK_5] = EFST_COLORS_OF_HYUN_ROK_5;
	StatusIconChangeTable[SC_COLORS_OF_HYUN_ROK_6] = EFST_COLORS_OF_HYUN_ROK_6;
	StatusIconChangeTable[SC_BLESSING_OF_M_C_DEBUFF] = EFST_BLESSING_OF_M_C_DEBUFF;
//#endif
	...
	StatusIconChangeTable[SC_RISING_SUN] = EFST_RISING_SUN;
	StatusIconChangeTable[SC_NOON_SUN] = EFST_NOON_SUN;
	StatusIconChangeTable[SC_SUNSET_SUN] = EFST_SUNSET_SUN;
	StatusIconChangeTable[SC_RISING_MOON] = EFST_RISING_MOON;
	StatusIconChangeTable[SC_MIDNIGHT_MOON] = EFST_MIDNIGHT_MOON;
	StatusIconChangeTable[SC_DAWN_MOON] = EFST_DAWN_MOON;
	...
	StatusIconChangeTable[SC_HNNOWEAPON] = EFST_NOEQUIPWEAPON;
	...
	// VIP Status
	StatusIconChangeTable[SC_VIP] = EFST_VIP;
	...
	// VIP Status
	StatusChangeFlagTable[SC_VIP] |= SCB_NONE;
			...
			switch(ud->skill_id) {
				...
				case MT_SUMMON_ABR_INFINITY: {
					...
					if (ud->skill_id == MT_SUMMON_ABR_INFINITY) {
						status->max_hp += 200000;
						status->rhw.atk += 5600; // 70% 
						status->rhw.atk2 += 8000;
					}
					}
					break;
...
//#ifdef RENEWAL
			if (sc->data[SC_ANGELUS])
				bonus += sc->data[SC_ANGELUS]->val1 * 1000;
			if (sc->data[SC_GUARD_STANCE])
				bonus += sc->data[SC_GUARD_STANCE]->val1 * 2000;
//#endif
		}
...
// ----- MISC CALCULATIONS -----
	...
	if(sc->count) {
		...
		if (sc->data[SC_TALISMAN_OF_FIVE_ELEMENTS]) {
			sd->right_weapon.addele[ELE_NEUTRAL] += sc->data[SC_TALISMAN_OF_FIVE_ELEMENTS]->val2;
			sd->right_weapon.addele[ELE_WATER] += sc->data[SC_TALISMAN_OF_FIVE_ELEMENTS]->val2;
			sd->right_weapon.addele[ELE_WIND] += sc->data[SC_TALISMAN_OF_FIVE_ELEMENTS]->val2;
			sd->right_weapon.addele[ELE_EARTH] += sc->data[SC_TALISMAN_OF_FIVE_ELEMENTS]->val2;
			sd->right_weapon.addele[ELE_FIRE] += sc->data[SC_TALISMAN_OF_FIVE_ELEMENTS]->val2;
			sd->indexed_bonus.magic_addele[ELE_NEUTRAL] += sc->data[SC_TALISMAN_OF_FIVE_ELEMENTS]->val2;
			sd->indexed_bonus.magic_addele[ELE_WATER] += sc->data[SC_TALISMAN_OF_FIVE_ELEMENTS]->val2;
			sd->indexed_bonus.magic_addele[ELE_WIND] += sc->data[SC_TALISMAN_OF_FIVE_ELEMENTS]->val2;
			sd->indexed_bonus.magic_addele[ELE_EARTH] += sc->data[SC_TALISMAN_OF_FIVE_ELEMENTS]->val2;
			sd->indexed_bonus.magic_addele[ELE_FIRE] += sc->data[SC_TALISMAN_OF_FIVE_ELEMENTS]->val2;
		}
		if (sc->data[SC_MYSTIC_SYMPHONY])
		{
			sd->indexed_bonus.magic_addrace[RC_DEMIHUMAN] += 30;
			sd->indexed_bonus.magic_addrace[RC_FISH] += 30;
			sd->right_weapon.addrace[RC_DEMIHUMAN] += 30;
			sd->right_weapon.addrace[RC_FISH] += 30;
			sd->left_weapon.addrace[RC_DEMIHUMAN] += 30;
			sd->left_weapon.addrace[RC_FISH] += 30;
		}
	}
...
static unsigned short status_calc_watk(struct block_list *bl, struct status_change *sc, int watk)
{
	...
	if (sc->data[SC_TALISMAN_OF_WARRIOR])
		watk += sc->data[SC_TALISMAN_OF_WARRIOR]->val2;
#ifndef RENEWAL
	if(sc->data[SC_NIBELUNGEN]) {
		if (bl->type != BL_PC)
...
static unsigned short status_calc_matk(struct block_list *bl, struct status_change *sc, int matk)
{
	...
	if (sc->data[SC_TALISMAN_OF_MAGICIAN])
		matk += matk * sc->data[SC_TALISMAN_OF_MAGICIAN]->val2/100;
	if (sc->data[SC_SUFFRAGIUM])
		matk += matk * sc->data[SC_SUFFRAGIUM]->val3/100;
...
static signed short status_calc_hplus(struct block_list *bl, struct status_change *sc, int hplus)
{
	...
	if (sc->data[SC_TEMPORARY_COMMUNION])
		hplus += sc->data[SC_TEMPORARY_COMMUNION]->val1 * 3;
...
t_tick status_get_sc_def(struct block_list *src, struct block_list *bl, enum sc_type type, int rate, t_tick tick, unsigned char flag)
{
	...
	switch (type) {
		...
		case SC_FREEZE:
			...
			sc_def = status->mdef*100;
			sc_def2 = status->luk*10 + status_get_lv(bl)*10 - status_get_lv(src)*10;
			tick_def = 5200 + status->luk*25;
			tick_def2 = status_src->luk*-10; // Caster can increase final duration with luk
			break;
		//case SC_FREEZE:
			//if (status->luk >= 150 && status->mdef <= 100 ){
				//tick_def = 9500;
				//sc_def = status->mdef*100;
			//}else if(status->mdef >= 100){
				//tick_def = 10000;
			//}else
				//sc_def = status->mdef*100;
				//sc_def2 = status->luk*10 + status_get_lv(bl)*10 - status_get_lv(src)*10;
...
//		if (util::vector_exists(status_get_race2(bl), RC2_GVG) && status_sc2scb_flag(type)&SCB_MAXHP) return 0;
	...
	case SC_MARINE_FESTIVAL_OF_KI_SUL:
		status_change_end(bl, SC_MARINE_FESTIVAL_OF_KI_SUL, INVALID_TIMER);
	...
	switch(type)
	{
		...
		case SC_DEVOTION:
		{
			...
			if( (d_bl = map_id2bl(val1)) && (d_sc = status_get_sc(d_bl)) && d_sc->count ) { // Inherits Status From Source
				...
				while( i >= 0 ) {
					...
					if( d_sc->data[type2] )
						status_change_start(d_bl, bl, type2, 10000, d_sc->data[type2]->val1, 0, 0, (type2 == SC_REFLECTSHIELD ? 1 : 0), skill_get_time(status_sc2skill(type2),d_sc->data[type2]->val1), SCSTART_NOAVOID);
					i--;
				}
			}
			break;
		...
		case SC_ATTACK_STANCE:
			...
			val3 = 3 * val1; // P.ATK and S.MATK Increase
			tick = INFINITE_TICK;
			break;
		case SC_HOLY_S:
		...
		case SC_TALISMAN_OF_FIVE_ELEMENTS:
			val2 = 4 * val1; // Physical / Magical Damage Increase on Elemental Monster
			break;
...
// 			break;
	...
	if(opt_flag) {
		...
		// Adjust the order of clif_changeoption and clif_changelook(bl,LOOK_BASE,vd->class_);
		// Although it doesn't seem to be needed in status_change_start at the moment, let's change it together
		clif_changeoption(bl);
	}
...
TIMER_FUNC(status_change_timer){
	...
	case SC_KI_SUL_RAMPAGE:
		if (sce->val4-- > 0)
		{
			...
			int lv = sce->val1;
			if (sd && pc_checkskill(sd, SH_COMMUNE_WITH_KI_SUL))
			{
				i += 2;
	...
	case SC_TALISMAN_OF_PROTECTION:
		if (sce->val4-- > 0)
		{
			int heal = 500*sce->val1+50*sce->val2;
			heal = heal*sce->val3 / 150;
